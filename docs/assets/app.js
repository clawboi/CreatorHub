...
async function loadProjects(){
  ...
  wrap.innerHTML =
    section('Pending', pending, 'Waiting for creator to accept/refuse.') +
    section('Current', current, 'Accepted and in progress.') +
    section('Completed', completed, 'Finished projects.') +
    (cancelled.length ? section('Cancelled', cancelled, 'Refused or cancelled.') : '');
