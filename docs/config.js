...
window.CREATORHUB_BASE = window.CREATORHUB_BASE || (function(){
...
// Build tag
window.CREATORHUB_BUILD = window.CREATORHUB_BUILD || "replacement-v11-auth-book-fix";
